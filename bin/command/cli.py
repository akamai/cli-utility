...
delivery = [{'name': 'behavior',
                  ...
                  'required_arguments': [{'name': 'property', 'help': 'property name', 'required': True}],
                 ...
                 {'name': 'metadata',
                  ...
                  'required_arguments': [{'name': 'property', 'help': 'property name', 'nargs': '+', 'required': True}],
                 ...
                 {'name': 'activate',
                  ...
                  'required_arguments': [{'name': 'file', 'help': 'excel file', 'required': True},
                                         {'name': 'email', 'help': 'notificatin email(s) for activations', 'nargs': '+', 'required': True},
                                         {'name': 'network', 'help': 'options: staging, production', 'default': 'staging', 'nargs': '+', 'required': True},
                                         {'name': 'note', 'help': 'activation note', 'nargs': '+', 'required': True}],
...
security = [{'name': 'hostname',
             ...
             'optional_arguments': [{'name': 'group-id', 'help': 'group-id', 'nargs': '+'},
                                    {'name': 'concurrency', 'help': 'process X [numeric] requests at a time', 'default': 1},
...
diff = [{'name': 'behavior',
                  ...
                  'required_arguments': [{'name': 'property', 'help': 'propertyname', 'nargs': '+', 'required': True}],
...
report = [{'name': 'list',
          ...
          {'name': 'offload-url', 'help': 'list report by url',
          ...
          {'name': 'offload-hostname', 'help': 'list report by hostname',
           'required_arguments': [{'name': 'last', 'help': 'last X interval', 'default': 7},
                                  {'name': 'interval', 'help': 'Options: MONTH, WEEK, DAY, HOUR, FIVE_MINUTES',
                                   'choices': ['MONTH', 'WEEK', 'DAY', 'HOUR', 'FIVE_MINUTES'],
                                   'default': 'HOUR'}],
           'optional_arguments': [{'name': 'cpcode', 'help': '1 or more reporting cpcodes ', 'nargs': '+'}]},
          {'name': 'response-class', 'help': 'list report by response codes',
           'required_arguments': [{'name': 'last', 'help': 'last X interval', 'default': 7},
                                  {'name': 'interval', 'help': 'Options: MONTH, WEEK, DAY, HOUR, FIVE_MINUTES',
                                   'choices': ['MONTH', 'WEEK', 'DAY', 'HOUR', 'FIVE_MINUTES'],
                                   'default': 'HOUR'}],
...
main_commands = [{'delivery': 'information detail about delivery configuration',
                 ...
                 {'diff': 'show compare report between two configurations. Both delivery and security configs are supported',
                  'required_arguments': [{'name': 'config1', 'help': 'config to compare', 'required': True}],
                 ...
                 {'ruleformat': 'information about ruleformat and behavior catalog',
                  'description': 'product_id, https://techdocs.akamai.com/property-mgr/reference/id-prefixes#common-product-ids',
                  'required_arguments': [{'name': 'product-id', 'required': True,
                 ...
                 {'log': 'review ghost logs, excel friendly (internal to Akamai employees only)',
                  'required_arguments': [{'name': 'input', 'help': 'location of file ending with gz extension', 'required': True}],
                 ...
                 'required_arguments': [{'name': 'account', 'help': 'keyword search at least 3 characters', 'nargs': '+', 'required': True}]},
                ]
