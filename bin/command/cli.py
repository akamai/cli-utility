...
bulk = [{'name': 'search',
        ...
        {'name': 'combine',
         'help': 'comebine 2 excels',
         'optional_arguments': [{'name': 'origin', 'help': 'excel contain search result from origin lookup'},
                                {'name': 'caching', 'help': 'excel contain search result from caching lookup'}]},
        {'name': 'create',
...
delivery = [{'name': 'add-ehn',
            ...
            {'name': 'hostname-cert',
             ...
             'required_arguments': [{'name': 'input', 'help': 'input filename.extension ie config.txt'},
                                    {'name': 'property', 'help': 'property name', 'nargs': '+'}],
             'optional_arguments': [{'name': 'version', 'help': 'version'},
                                    {'name': 'network', 'help': 'latest, staging, production',
                                     'choices': ['latest', 'staging', 'production'],
            ...
            {'name': 'jsonpath',
             ...
             'required_arguments': [{'name': 'input', 'help': 'input filename.extension ie config.txt'},
                                    ...
                                    {'name': 'type', 'help': 'Options: criteria, behavior', 'nargs': '+',
                                     'choices': ['behavior', 'criteria', 'condition'],
            ...
            'optional_arguments': [{'name': 'group', 'help': 'provide at least one numeric group id without prefix grp_ ', 'nargs': '+'},
