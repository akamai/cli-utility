    ...
    def get_args(cls):
        ...
        report_sc = [{'name': 'list',
                     ...
                     {'name': 'offload-url',
                      ...
                      'required_arguments': [{'name': 'last', 'help': 'last X interval',
                                              'default': 7},
                     ...
                     {'name': 'offload-hostname',
                      'help': 'list report by hostname',
                      'required_arguments': [{'name': 'last', 'help': 'last X interval',
                                              'default': 7},
                                             {'name': 'interval', 'help': 'Options: MONTH, WEEK, DAY, HOUR, FIVE_MINUTES',
                                              'choices': ['MONTH', 'WEEK', 'DAY', 'HOUR', 'FIVE_MINUTES'],
        ...
        actions['report'] = cls.create_main_command(
                            subparsers, 'report',
                            help='list traffic report https://techdocs.akamai.com/reporting/reference/supported-time-intervals',
    ...
    def add_arguments(cls, action, required_arguments=None, optional_arguments=None):
        ...
        if optional_arguments:
            ...
            optional.add_argument('--log-level',
                                  ...
                                  default='info',
                                  help='Set the log leve. To noisy, increase to warning',
                                 )
